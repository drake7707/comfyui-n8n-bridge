...
export interface PromptEntry {
    ...
    onNodeExecuted: (nodeId: string, output: any) => void
    onStart: () => void
    onFinish: () => void;
...
export class ComfyUI {
    ...
    private registeredPrompts: { [key: string]: PromptEntry } = {};
    ...
    async queue(prompt: any, onUpdate: (entry: PromptEntry) => void) {
        ...
        const promiseResult = new Promise<PromptEntry>((onResolve, onError) => {
            //console.log(data);
